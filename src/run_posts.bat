...
if not exist "stress_test_tool_posts.py" (
    echo.
    echo ERROR: El sistema no puede encontrar el archivo "stress_test_tool_posts.py"
    echo.
    echo SOLUCIÓN:
...
start "" /B cmd /c "!PYTHON! stress_test_tool_posts.py & exit"
exit