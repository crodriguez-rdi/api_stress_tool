    ...
    def discover_endpoints(self):
        ...
        endpoints_config = {
            ...
            "FROM_FORM": {
                ...
                "/AvDeviceType/CreateAvDeviceType/1": {
                    "data": {
                        "Id": "0",
                        "Nombre": "Tipo de dispositivo"
                    }
                },
                "/ConsoleDevice/SetConsoleStatusAction": {
                    "params": {
                        "idUser": "1",
                        "idWorkplace": "1",
                        "action": "up"
                ...
                "/RoomOverview/SetWorkplacesOnStatus": {
                    "params": {
                        "status": "1",
                        "idUser": "1"
                    },
                ...
                "/RoomOverview/SetWorkplacesOnIntegration": {
                    "params": {
                        "integration": "1",
                        "idUser": "1"
                    },
                ...
                "/RoomOverview/SetWorkplacesHeight": {
                    "params": {
                        "up": "true",
                        "idUser": "1"
                    },
                ...
                "/RoomOverview/SetWorkplacesConnecivity": {
                    "params": {
                        "on": "true",
                        "idUser": "1"
                    },
                ...
                "/RoomOverview/SetWorkplaceLightState": {
                    "params": {
                        "on": "true",
                        "idUser": "1"
                    },
                ...
                "/TypeCallforsupp/CreateTypeCallforsupp": {
                    "data": {
                        "TypeCallforsupp.Id": "0",
                        "TypeCallforsupp.Name": "Soporte técnico",
                        "TypeCallforsupp.Description": "Descripción del tipo",
                        "TypeCallforsupp.Photo_URL": "http://example.com/foto.jpg",
                        "TypeCallforsupp.RoleReceiverIds": [1, 2],
                        "TypeCallforsupp.RoleSenderIds": [3],
                        "TypeCallforsupp.AnswerIds": [1],
                        "TypeCallforsupp.Color": "#FF0000",
                        "TypeCallforsupp.MessageNotification": "Mensaje de alerta",
                        "TypeCallforsupp.Criticity": "true",
                        "TypeCallforsupp.CriticityLevel": 1,
                        "Photo": "Null"
                    }
                },
                "/VuwallDestination/AddDestination": {
                    "data": {
                        "Name": "Destino Principal",
                        "Description": "Pantalla principal de visualización",
                        "Destination_Id": 1,
                        "Active": "true"
                    }
                },
                "/VuwallScenario/AddScenario": {
                    "data": {
                        "Name": "Escenario de Emergencia",
                        "Description": "Configuración para situaciones de emergencia",
                        "Scenario_Id": 1,
                        "Active": "true"
                    }
                },
                "/VuwallSource/AddSource": {
                    "data": {
                        "Name": "Cámara Principal",
                        "Description": "Fuente de video del área principal",
                        "Source_Id": 1,
                        "Active": "true"
                    }
                },
            ...
            "FROM_BODY": {
                "/Cam/ReceiveCam": {
                    "data": {
                        ...
                        "sn": "CAM12345",
                        "type": "IP Camera",
                        "camDate": "2025-04-09T10:53:06.105Z",
                        "pictureBase64List": ["iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8z/C/HgAGgwJ/lK3Q6wAAAABJRU5ErkJggg=="],
                        "pictureCoordinates": [0],
                        "camVideo": "video_stream_url",
                        "active": True
                    }
                },
                "/Auth/Login": {
                ...
                "/Area/CreateArea": {
                    "data": {
                        ...
                        "area_DTO": {
                            "id": 1,
                            "name": "Parent Area",
                            "description": "Parent Area Description"
                        }
                    }
                },
    ...
    def send_request(self, session, endpoint_info):
        ...
        try:
            ...
            if endpoint_info['type'] == 'form':
                # Handle query parameters for form endpoints
                ...
                response = session.post(
                    url,
                    data=endpoint_info['config']['data'],
                    headers={'Content-Type': 'application/x-www-form-urlencoded'},
                    timeout=10
                )
            else:  # JSON endpoints
                response = session.post(
                    url,
                    json=endpoint_info['config']['data'],
                    timeout=10
                )
