...
datos_usuarios = [
    {"ip": "192.168.0.1", "idWorkplace": "1"},
    {"ip": "192.168.0.2", "idWorkplace": "2"},
    {"ip": "192.168.1.52", "idWorkplace": "3"},
    {"ip": "192.168.0.4", "idWorkplace": "4"},
    {"ip": "192.168.0.5", "idWorkplace": "5"},
    {"ip": "192.168.0.6", "idWorkplace": "6"},
    {"ip": "192.168.0.7", "idWorkplace": "7"},
    {"ip": "192.168.0.8", "idWorkplace": "8"},
    {"ip": "192.168.0.9", "idWorkplace": "9"},
    {"ip": "192.168.0.10", "idWorkplace": "10"},
    {"ip": "192.168.0.11", "idWorkplace": "11"},
    {"ip": "192.168.0.12", "idWorkplace": "12"},
    {"ip": "192.168.0.13", "idWorkplace": "13"},
    {"ip": "192.168.0.14", "idWorkplace": "14"},
    {"ip": "192.168.0.15", "idWorkplace": "15"},
    {"ip": "192.168.0.17", "idWorkplace": "17"},
    {"ip": "192.168.0.18", "idWorkplace": "18"},
    {"ip": "192.168.0.19", "idWorkplace": "19"},
    {"ip": "192.168.0.20", "idWorkplace": "20"},
    {"ip": "192.168.0.21", "idWorkplace": "21"},
    {"ip": "192.168.0.22", "idWorkplace": "22"},
    {"ip": "192.168.0.23", "idWorkplace": "23"},
    {"ip": "192.168.0.24", "idWorkplace": "24"},
    {"ip": "192.168.0.25", "idWorkplace": "25"},
    {"ip": "192.168.0.26", "idWorkplace": "26"},
    {"ip": "192.168.0.27", "idWorkplace": "27"},
    {"ip": "192.168.0.28", "idWorkplace": "28"},
    {"ip": "192.168.0.29", "idWorkplace": "29"},
    {"ip": "192.168.0.30", "idWorkplace": "30"},
    {"ip": "192.168.0.31", "idWorkplace": "31"},
    {"ip": "192.168.0.32", "idWorkplace": "32"},
    {"ip": "192.168.0.33", "idWorkplace": "33"},
    {"ip": "192.168.0.34", "idWorkplace": "34"},
    {"ip": "192.168.0.35", "idWorkplace": "35"},
    {"ip": "192.168.0.36", "idWorkplace": "36"},
    {"ip": "192.168.0.37", "idWorkplace": "37"},
    {"ip": "192.168.0.38", "idWorkplace": "38"},
    {"ip": "192.168.0.39", "idWorkplace": "39"},
    {"ip": "192.168.0.40", "idWorkplace": "40"},
    {"ip": "192.168.0.41", "idWorkplace": "41"},
    {"ip": "192.168.0.42", "idWorkplace": "42"},
    {"ip": "192.168.0.43", "idWorkplace": "43"},
    {"ip": "192.168.0.44", "idWorkplace": "44"},
    {"ip": "192.168.0.45", "idWorkplace": "45"},
    {"ip": "192.168.0.46", "idWorkplace": "46"},
    {"ip": "192.168.0.47", "idWorkplace": "47"},
    {"ip": "192.168.0.48", "idWorkplace": "48"},
    {"ip": "192.168.0.49", "idWorkplace": "49"},
    {"ip": "192.168.0.50", "idWorkplace": "50"},
    {"ip": "192.168.0.51", "idWorkplace": "51"}
]
...
class APITestApp:
    ...
    def discover_endpoints(self):
        ...
        endpoints_config = {  
            "GET": {  # Usar GET aquí para los endpoints que son GET
                "/Auth/LogoutCustom": {
                    "data": {
        ...
        def test_endpoint(endpoint_type, endpoint, config):
            ...
            try:
                ...
                # Manejo de parámetros query para endpoints GET
                if endpoint_type == "GET" and "data" in config:
                    url += "?" + "&".join([f"{k}={v}" for k, v in config["data"].items()])
                ...
                else:  # FROM_BODY o cualquier otro tipo de post
                ...
                if response.status_code < 400:
                    discovered_endpoints.append({
                        'endpoint': endpoint,
                        'type': 'GET' if endpoint_type == "GET" else 'json',
                        'config': config
                    })
        ...
        for endpoint_type, endpoints in endpoints_config.items():
            ...
            for endpoint, config in endpoints.items():
                ...
                if not test_endpoint(endpoint_type, endpoint, config):
                    ...
                    alt_type = "FROM_BODY" if endpoint_type == "GET" else "FROM_FORM"
    ...
    def send_request(self, session, endpoint_info):
        """Send a request (GET or POST) with proper formatting based on endpoint type"""
        ...
        try:
            # Generar valor único para IP y workplace
            n = random.randint(1, 51)
            remote_ip = f"192.168.0.{n}"
            id_workplace = n

            # Construir URL con parámetros para GET o datos para POST
            if endpoint_info['type'] == 'form' or endpoint_info['type'] == 'GET':
                # GET con parámetros en query string
                query_params = {
                    "remoteIpAddress": remote_ip,
                    "idWorkplace": id_workplace
                }
                ...
                response = session.post(url, json=data_to_send, headers=headers, timeout=10)
            ...
            log_msg = [
                ...
                f"Status: {status}",
                f"Time: {elapsed:.3f}s",
                f"remoteIpAddress: {remote_ip} | idWorkplace: {id_workplace}"
            ]
